...
class MediaPage(AbstractTweetPage):
    def get_url_prefix_suffix(self, rest_id: str) -> tuple:
        url_prefix = 'https://x.com/i/api/graphql/dexO_2tohK86JDudXXG3Yw/UserMedia?variables={"userId":"' + rest_id + '","count":' + str(self.page_count) + ','
...
if __name__ == "__main__":
    if (len(sys.argv) < 2):
        ...
        exit(-1)
    rest_id = sys.argv[1]
    tweet = MediaPage(CommonDownloader(), MediaParser())
